...
- Added an OpenRouter adapter + builder (chat, streaming, embeddings, health/models) with BYOK-friendly overrides, config defaults for attribution headers, cached catalog discovery, and frontend hooks ready for the forthcoming model-import UX.
