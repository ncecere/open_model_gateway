...
2. After signing in to the user portal, select the tenant you plan to use. Personal tenants are auto-created for individual experimentation.
...
- Supported endpoints include:
  ...
  - `/v1/files` CRUD
  - `/v1/batches`
- See `../reference/requests.md` and `Code_Examples/curl` for copy/paste snippets of every endpoint.
